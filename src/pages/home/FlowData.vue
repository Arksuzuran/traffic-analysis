...
<!--			<home-header />-->
			<div style="padding: 0 8px" class="chart-content">
				...
				<a-row :gutter="[8, 8]" class="chart-content-row">
					<!-- 左侧 -->
					<a-col v-bind="leftCol" class="chart-content-col">
						<div id="map"></div>
					</a-col>
					<!-- 右侧 -->
					<a-col v-bind="rightCol" class="chart-content-col">
						<a-row class="chart-content-right">
							<a-col class="chart-content-right-item" :span="24">
								<ModuleItem title="时间选择" :loading="initLoading">
									<Calendar></Calendar>
								</ModuleItem>
							</a-col>
<!--							<a-col class="chart-content-right-item" :span="24">-->
...
<!--							</a-col>-->
							<a-col class="chart-content-right-item" :span="24">
								<ModuleItem title="单车流量" :loading="initLoading">
...
import Calendar from "@/components/DateSelector/Calendar.vue";
...
import { titleList, leftRightCol, centerCol, leftCol, rightCol } from './config';
